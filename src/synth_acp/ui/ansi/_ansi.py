...
from synth_acp.ui.ansi._ansi_colors import ANSI_COLORS
from synth_acp.ui.ansi._control_codes import CONTROL_CODES
from synth_acp.ui.ansi._dec import CHARSET_MAP
from synth_acp.ui.ansi._keys import CURSOR_KEYS_APPLICATION, TERMINAL_KEY_MAP
from synth_acp.ui.ansi._sgr_styles import SGR_STYLES
from synth_acp.ui.ansi._stream_parser import (
    ParseResult,
    Pattern,
    PatternCheck,
    PatternToken,
...
class DECState:
    ...
    def update(self, dec: DEC | None, dec_invoke: DECInvoke | None) -> None:
        if dec is not None:
            ...
            elif dec_invoke.gl is not None:
